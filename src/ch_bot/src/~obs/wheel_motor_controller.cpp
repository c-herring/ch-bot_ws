...
#include <sstream>
#include "mecanum_bot_msgs/motors.h"
...
class MotorController
{
	...
	private:
		...
		mecanum_bot_msgs::motors enc_msg;
		mecanum_bot_msgs::motors vel_msg;
		...
		void set_vel_callback(const mecanum_bot_msgs::motors::ConstPtr& msg);
...
MotorController::MotorController()
{
	...
	set_vel = nh.subscribe<mecanum_bot_msgs::motors>("vel_set", 100, &MotorController::set_vel_callback, this);
	...
	encoderPub = nh.advertise<mecanum_bot_msgs::motors>("encoder_pos", 100);	
	velPub = nh.advertise<mecanum_bot_msgs::motors>("encoder_vel", 100);
...
void MotorController::set_vel_callback(const mecanum_bot_msgs::motors::ConstPtr& msg)
{
